...
export default class Auth extends Component {
  ...
  loginHandler = async () => {
    ...
    try {
      const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDSXo66otszbDqkZb97K4LyL0EwycNSnrM',authData);
